...
// 🟪🟥🟪🟥🟪🟥 DragRoll: Defines Sheet Roll Throughout Construction 🟥🟪🟥🟪🟥🟪
class DragRoll {
	// ▓▓▓▓▓▓▓ CONSTRUCTOR ▓▓▓▓▓▓▓
	...
	// ████████ DRAGGABLE DISPLAY: Managing Roll Description & Icons on Draggable Element ████████
	// ▓▓▓▓▓▓▓ Icons ▓▓▓▓▓▓▓
	...
	// ████████ PUBLIC METHODS: Manipulating Roll Elements, Launching Roll ████████
...
// 🟪🟥🟪🟥🟪🟥 BetterAngelsActorSheet: Primary Extension of Base ActorSheet Class 🟥🟪🟥🟪🟥🟪
class BetterAngelsActorSheet extends MIX(ActorSheet).with(UpdateQueue) {
	...
	// ████████ DRAG-ROLLS: Implementation of DragRoll to Construct Rolls Via Drag/Drag-Over/Drop Interactions ████████
	...
	// ▓▓▓▓▓▓▓[Triggers]▓▓▓▓ Events Triggering Timeline Control ▓▓▓▓▓▓▓
	...
	// ▓▓▓▓▓▓▓[Launch Roll]▓▓▓▓ Interfacing With Foundry Roller on Roll Complete ▓▓▓▓▓▓▓
	...
	// ████████ TRAIT GRID: Radial Menu, Dot Animations, Demonic Influence ████████
	// ▓▓▓▓▓▓▓ Trait Data Retrieval ▓▓▓▓▓▓▓
