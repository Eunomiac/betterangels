/* ▌██░░ betterangels v0.0.1-prealpha (2021) ║ MIT License ║ https://github.com/Eunomiac/betterangels ░░██▐ */// Can EASILY modify the snapping to first check if it has been moved a minimum distance
