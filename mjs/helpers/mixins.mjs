...
// #region ████████ XELEMS: XElem, XCircle, XItem, XDie, XSnap Mixins ████████
...
// #endregion ▄▄▄▄▄ XELEMS ▄▄▄▄▄
// #region ████████ SHEETS: Actor/Item Sheet Mixins ████████ ~
export const UpdateQueue = (superclass) => class extends superclass {
	get pendingUpdates() { return (this._pendingUpdates = this._pendingUpdates ?? {}) }
	get entityData() { return U.merge(this.document.data, U.expand(this.pendingUpdates)) }
	get actorData() { return this.entityData }
	get itemData() { return this.entityData }

	updateSync(updateData) {
