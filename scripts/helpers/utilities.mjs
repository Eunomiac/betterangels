...
// #region ▮▮▮▮▮▮▮[DATA] Data & References Used by Utility Functions ▮▮▮▮▮▮▮ ~
...
//~ console.log(Object.entries(objTypes).map(([k,v]) => `${k} -> ${getType(v)} (${hasItems(v)}, ${isIterable(v)})`));
...
// #region ░░░░░░░[Angles]░░░░ Angles, Trigonometry ░░░░░░░ ~
