...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module 
    ? e(exports) 
    : "function" == typeof define && define.amd ? define(["exports"], e) : e(((t = t || self).window = t.window || {}));
})(this, function (e) {
  "use strict";
  function m() {
  ...
  function aa(t, e, n, i, r, o, a) {
      ...
      return n < c ? (c = n) : c < i && (c = i), { max: c, min: c, unitFactor: t.unitFactor };
  }
  function ba(t, e, n) {
  ...
  var v,
      ...
      I = true /* (function (t) {
          var e = 0 === (window ? window.location.href : "").indexOf(Q(102, 105, 108, 101, 58, 47, 47)) 
          ...
          var n = [
                  ...
                  Q(99, 111, 100, 101, 112, 101, 110, 46, 112, 108, 117, 109, 98, 105, 110, 103),
                  Q(99, 111, 100, 101, 112, 101, 110, 46, 100, 101, 118),
                  Q(99, 111, 100, 101, 112, 101, 110, 46, 97, 112, 112),
                  Q(99, 111, 100, 101, 112, 101, 110, 46, 119, 101, 98, 115, 105, 116, 101),
                  ...
                  Q(116, 104, 101, 109, 101, 102, 111, 114, 101, 115, 116, 46, 110, 101, 116),
                  ...
                  Q(109, 111, 116, 105, 111, 110, 116, 114, 105, 99, 107, 115, 46, 99, 111, 109),
                  Q(115, 116, 97, 99, 107, 111, 118, 101, 114, 102, 108, 111, 119, 46, 99, 111, 109),
                  Q(115, 116, 97, 99, 107, 101, 120, 99, 104, 97, 110, 103, 101, 46, 99, 111, 109),
          ...
          for (
              setTimeout(function () {
                ...
                //  Q(102, 111, 110, 116, 45, 115, 105, 122, 101, 58, 51, 48, 112, 120, 59, 99, 111, 108, 111, 114, 58, 114, 101, 100, 59)
                // ),
                console.log(`A trial version of ${E} is loaded that only works locally and on domains like codepen.io and codesandbox.io.
                *** DO NOT DEPLOY THIS FILE *** Loading it on an unauthorized site violates the license and will cause a redirect. Please
                join Club GreenSock to get full access to the bonus plugins that boost your animation superpowers.
                Disable this warning with gsap.config({trialWarn: false});`),
                // console.log(Q(65, 32, 116, 114, 105, 97, 108, 32, 118, 101, 114, 115, 105, 111, 110, 32, 111, 102, 32) 
                //   + E 
                //   + Q(32, 105, 115, 32, 108, 111, 97, 100, 101, 100, 32, 116, 104, 97, 116, 32, 111, 110, 108, 121, 32, 119, 111, 114, 107, 115, 32, 108, 111, 99, 97, 108, 108, 121, 32, 97, 110, 100, 32, 111, 110, 32, 100, 111, 109, 97, 105, 110, 115, 32, 108, 105, 107, 101, 32, 99, 111, 100, 101, 112, 101, 110, 46, 105, 111, 32, 97, 110, 100, 32, 99, 111, 100, 101, 115, 97, 110, 100, 98, 111, 120, 46, 105, 111, 46, 32, 42, 42, 42, 32, 68, 79, 32, 78, 79, 84, 32, 68, 69, 80, 76, 79, 89, 32, 84, 72, 73, 83, 32, 70, 73, 76, 69, 32, 42, 42, 42, 32, 76, 111, 97, 100, 105, 110, 103, 32, 105, 116, 32, 111, 110, 32, 97, 110, 32, 117, 110, 97, 117, 116, 104, 111, 114, 105, 122, 101, 100, 32, 115, 105, 116, 101, 32, 118, 105, 111, 108, 97, 116, 101, 115, 32, 116, 104, 101, 32, 108, 105, 99, 101, 110, 115, 101, 32, 97, 110, 100, 32, 119, 105, 108, 108, 32, 99, 97, 117, 115, 101, 32, 97, 32, 114, 101, 100, 105, 114, 101, 99, 116, 46, 32, 80, 108, 101, 97, 115, 101, 32, 106, 111, 105, 110, 32, 67, 108, 117, 98, 32, 71, 114, 101, 101, 110, 83, 111, 99, 107, 32, 116, 111, 32, 103, 101, 116, 32, 102, 117, 108, 108, 32, 97, 99, 99, 101, 115, 115, 32, 116, 111, 32, 116, 104, 101, 32, 98, 111, 110, 117, 115, 32, 112, 108, 117, 103, 105, 110, 115, 32, 116, 104, 97, 116, 32, 98, 111, 111, 115, 116, 32, 121, 111, 117, 114, 32, 97, 110, 105, 109, 97, 116, 105, 111, 110, 32, 115, 117, 112, 101, 114, 112, 111, 119, 101, 114, 115, 46, 32, 68, 105, 115, 97, 98, 108, 101, 32, 116, 104, 105, 115, 32, 119, 97, 114, 110, 105, 110, 103, 32, 119, 105, 116, 104, 32, 103, 115, 97, 112, 46, 99, 111, 110, 102, 105, 103, 40, 123, 116, 114, 105, 97, 108, 87, 97, 114, 110, 58, 32, 102, 97, 108, 115, 101, 125, 41, 59))
                // ),
                console.log("%cGet unrestricted files at https://greensock.com/club", "font-size:16px;color:#4e9815"),
                // console.log(
                //   Q( 37, 99, 71, 101, 116, 32, 117, 110, 114, 101, 115, 116, 114, 105, 99, 116, 101, 100, 32, 102, 105, 108, 101, 115, 32, 97, 116, 32, 104, 116, 116, 112, 115, 58, 47, 47, 103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109, 47, 99, 108, 117, 98 ),
                //   Q(102, 111, 110, 116, 45, 115, 105, 122, 101, 58, 49, 54, 112, 120, 59, 99, 111, 108, 111, 114, 58, 35, 52, 101, 57, 56, 49, 53)
                // ),
          ...
          return (
              e ||
              !setTimeout(function () {
                  window.location.href = Q(104, 116, 116, 112, 115, 58, 47, 47) + j + Q(47, 114, 101, 113, 117, 105, 114, 101, 115, 45, 109, 101, 109, 98, 101, 114, 115, 104, 105, 112, 47) + "?plugin=" + E + "&source=trial";
              }, 3e3)
          );
      })(window ? window.location.host : "") */,
      B = Array.isArray,
      R = 1e10,
      W = { resistance: 1, checkpoint: 1, preventOvershoot: 1, linkedProps: 1, radius: 1, duration: 1 },
      S = {
          version: "3.8.0",
          name: "inertia",
          ...
          init: function init(t, e, n, i, r) {
                  ...
                  k = L(m)
                      ...
                      : (function _calculateTweenDuration(t, e, n, i, r, o) {
                            ...
                            for (a in ((h = fa(t, y, w, Q)), y))
                                W[a] ||
                                    ((c = y[a]),
                                    M(c) || ((g = g || C(t)) && g.isTracking(a) ? (c = L(c) ? { velocity: c } : { velocity: g.get(a) }) : ((u = +c || 0), (s = Math.abs(u / Q)))),
                                    M(c) &&
                                        ...
                                        "end" in c && ((c = aa(c, h && a in h ? h : l, c.max, c.min, a, y.radius, u)), o && (A === e && (A = y = $(e)), (y[a] = Z(c, y[a], "end")))),
                                        "max" in c && l > +c.max + 1e-10
                                            ? ((d = c.unitFactor || b.unitFactors[a] || 1), (p = (f > c.max && c.min !== c.max) || (-15 < u * d && u * d < 45) ? i + 0.1 * (n - i) : da(f, c.max, u)) + r < m && (m = p + r))
                                            : "min" in c &&
                                              l < c.min - 1e-10 &&
                                              ((d = c.unitFactor || b.unitFactors[a] || 1), (p = (f < c.min && c.min !== c.max) || (-45 < u * d && u * d < 15) ? i + 0.1 * (n - i) : da(f, c.min, u)) + r < m && (m = p + r)),
                                        v < p && (v = p)),
                                    v < s && (v = s));
              ...
              for (a in ((e = A), (A = 0), (d = fa(t, e, v, Q)), e))
                  W[a] ||
                      ...
                      M(c) &&
                          ((p = s + l),
                          "end" in c && (c = aa(c, d && a in d ? d : p, c.max, c.min, a, e.radius, f)),
